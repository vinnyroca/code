...
layout: page
title: Performance
permalink: /Projects/03_performance/
---
...
1. Your performance tool will make use of the ml5.js library. You can use BodyPose, HandPose, FaceMesh or SoundClassifier.
2. The aesthetic design of your tool should add to your performance. Default shapes are discouraged unless they strictly relate to your performance.
3. The duration of your performance should be no longer than 5 minutes.
4. Your performance should not be a simple demonstration of the tool.
5. Your performance should be rehearsed and recorded in advanced
...
- [Coding Train hand pose ](https://www.youtube.com/watch?v=vfNHdVbE-l4&list=PLRqwX-V7Uu6YPSwT06y_AEYTqIwbeam3y&index=6)
- [Coding Train faceMesh](https://www.youtube.com/watch?v=R5UZsIwPbJA) 
- [Coding Train Body Pose](https://www.youtube.com/watch?v=T99fNXTUUaQ&t=1200s) 
- [Coding Train live video and create capture videos](https://thecodingtrain.com/tracks/pixels/pixels/createCapture) 
