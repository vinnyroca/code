...
layout: page
title: Game Ring
permalink: /Projects/04_game/
---
# Game Ring

## Summary

For this project, each student will create and host their own personal website. This personal website will be connected to all the other student websites in the class through a [web ring](https://en.wikipedia.org/wiki/Webring). This personal website will exist as a personal narrative on the web.The goal of this project is two-fold: to think about the internet as a site for personal authorship and self-expression and to consider how we can use games or other interactive media to tell a personal story.
...
Some resources to explore include this [collection](https://www.webdesignmuseum.org/golden-age-of-web-design) of 90’s and 2000’s websites as well as this [link](https://contemporary-home-computing.org/prof-dr-style/) which explores the early web design of “Prof. Dr.” websites.
...
- [Dys4ia](https://w.itch.io/dys4ia), Anna Anthropy 
- [Celeste](https://www.celestegame.com/), Maddie Makes Games 
-  [Loading…](https://store.steampowered.com/app/2163660/Loading/) , Dzuy Anh Do 
- [Manichi](http://www.mattiebrice.com/mainichi/), Mattie Brice 
- [Curtain](https://dreamfeel.itch.io/curtain), Llaura McGee
