...
In the Discord channel for Response 4 and Canvas, post either a 500 word or 3 min video response considering the following questions (these are not strict questions to answer, but rather starting points for thinking about these sources):
